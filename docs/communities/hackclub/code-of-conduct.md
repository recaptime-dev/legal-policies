...
This page is a copy of Hack Club Code of Conduct found at <https://hackclub.com/conduct/>
([source Markdown text]). As a future fiscally-hosted organization under [HCB], a project by
The Hack Foundation (d.b.a. Hack Club), it's natural to adopt them alongside our own code of conduct,
much like requiring the adoption of CNCR Code of Conduct for incubiating projects there.

If you have any questions regarding our adoption of this CoC, please do not hesitate to email
<modteam@recaptime.dev> or <abuse@recaptime.dev>.

[source Markdown text]: https://github.com/hackclub/.github/blob/main/CODE_OF_CONDUCT.md
